...
const gameData = {
    start: {
        ...
        commands: {
            'start': { 
                        output: `You're in a dark room. There's a telephone across the room loudly ringing. You don't know how long it's
                        been going off. It's been a long day at the hospital, and you always find yourself in a deep slumber shortly after 
                        arriving home. You don't know when you fell asleep (or for how long), on the couch nonetheless, but you pick yourself up and stretch your arms
            ...
            'pick up glasses': {
                        output: `You bend over and pick up your glasses. They're a rather small pair of round frames that have lasted you almost
            ...
            'look': { 
                        output: `You're in the living room. You just got up from the couch which seems to be your new favorite sleeping spot. 
                        A large maroon patterned rug covers the dusty wooden floor. There's a taxidermied tiger that you and your friends hunted last year on 
                        display on top of a small table by the staircase. Next to it is a lone black telephone. Being the only doctor in the village, your house is one of the few 
                        to have a telephone in order to take emergency calls from the village hospital, but you can't say you've ever gotten used to the noise. 
        ...
        commands: {
            ...
            'take journal': { output: `You pick up the journal and slide it into the pocket of your jacket.`,
                              action: function() {
                                    ...
                                    A mirror hangs by the bedroom door. There's a small nightstand next to your side of the bed.`;
                                }
            },
    ...
    diningroom: {
        description: `The dining table is cluttered with crumpled up homework sheets and dull pencils. Despite how many times you've
                        scolded your children to keep the room tidy, it always seems to undo itself by the end of the day.  An unlit gas lamp sits at the end of the table with a matchbox beside it.`,
        commands: {
            'go north': { output: `You can not move north from here.`},
            'go south': { output: `You can not move south from here`}, 
